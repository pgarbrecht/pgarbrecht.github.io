const INFO = {
	...
	projects: [
		...
		},
		{
			title: "Family Gains",
			description:
				"I am the founder of Family Gains and serve as the lead engineer for our business website and software products. Family Gains is a children’s education company that provides resources to help parents raise their kids from early age to adulthood. The business began as an online store that sold at-home learning activity kits and games. I architected the website and built the infrastructure using React.js, Tailwind, Node.js, MongoDB, and Stripe integration for checkout, partnering with my wife on development. An admin dashboard was built to allow broader team members to log in and easily add or edit products. The online store helped achieve 25% YoY revenue increase and it remains in use on the website while the business is in the process of expanding to software products. My current focus is on building out the learning subscription app which will be available as a React.js web app and React Native mobile app. This app allows kids to control a character and explore a 3D town (built with Three.js) with many learning activities in it that change as they age. There are also plans to develop an online, interactive tutoring service using similar 3D functionality as in the app, along with media.",
			mediums: ["Desktop", "Mobile"],
